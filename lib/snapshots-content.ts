...
export const snapshotsContent: Record<string, CompanySnapshot> = {
  'disney': {
    ...
    marketCap: '~$198B',
    employees: 220000,
    revenue: '$25.2B Q2 FY2026',
    founded: 1923,
    dimensions: [
      { dimension: 'Decision Latency', score: 6, explanation: 'Parks, studios, ESPN, streaming, products, and cruises still move through heavy approval paths. The new push is cross-system speed, but old segment logic keeps taxing every big move.' },
      { dimension: 'Error Correction', score: 6, explanation: 'Streaming profitability proves correction capacity. The loop still runs slowly because sports rights, parks capital, and franchise planning all carry long tails.' },
      { dimension: 'Knowledge Location', score: 7, explanation: 'The best customer knowledge sits across park apps, streaming accounts, ticketing, retail, and sports. Disney has the raw signal; the hard part is making each division act on one guest picture.' },
      { dimension: 'Structural Lock-In', score: 7, explanation: 'Parks, cruise ships, ESPN rights, studio calendars, and franchise roadmaps create enormous commitment weight. Every strategic update arrives with existing inventory attached.' },
      { dimension: 'Talent Flow', score: 6, explanation: 'Creative, technical, parks, and sports talent operate under different clocks. Leadership transition adds another layer of career watching inside an already political system.' },
      { dimension: 'Capital Intensity', score: 8, explanation: 'Experiences growth needs ships, lands, rides, hotels, and maintenance before the guest shows up. Streaming needs content and technology before churn improves.' },
      { dimension: 'Knowledge Velocity', score: 6, explanation: 'Disney can learn quickly inside a single product line. The drag appears when park behavior, streaming taste, sports fandom, and merchandise intent need to move together.' },
    ],
    pattern: 'The Castle Wants A Customer File',
    patternDescription: 'Disney is trying to turn a century of characters, parks, sports, cruises, and streaming into one customer loop. The visible story is streaming profit and parks durability. The deeper move is identity: one family account able to steer trips, ads, content, merchandise, sports bundles, and franchise demand. The friction is old Disney structure. Each division still protects its own calendar, budget, and scoreboard while the customer already experiences one Disney life.',
    keyNumbers: [
      'Q2 FY2026 revenue: $25.2B, up 7%',
      'Q2 FY2026 income before taxes: $3.4B, up 9%',
      'Disney+ and Hulu streaming operating income: $582M',
      'Disney database GPI: 6.50, Transitioning',
      'Employee count in GPI database: 220,000',
    ...
    quotable: 'Disney used to own childhood memory. The next fight is owning behavioral memory before the family trip, during the game, after the movie, and inside the cart. The company with the cleanest guest file gets to decide which franchise gets fed before the audience even asks for it.',
    sources: [
      { title: 'Disney Quarterly Results', url: 'https://investors.thewaltdisneycompany.com/financials/quarterly-results/default.aspx' },
      { title: 'Disney Q2 FY2026 Earnings PDF', url: 'https://s206.q4cdn.com/979796730/files/doc_financials/2026/q2/q2-fy26-earnings.pdf' },
    ],
  },
  ...
  'netflix': {
    ...
    marketCap: '~$500B',
    employees: 16000,
    revenue: '$12.3B Q1 2026',
    founded: 1997,
    dimensions: [
      { dimension: 'Decision Latency', score: 3, explanation: 'Netflix still moves quickly from signal to product: paid sharing, ads, live events, games, and format tests all show short decision loops.' },
      { dimension: 'Error Correction', score: 3, explanation: 'The company cuts, reprices, tests, and re-allocates with limited ceremony. The biggest risk is overconfidence from a winning model rather than frozen decision paths.' },
      { dimension: 'Knowledge Location', score: 3, explanation: 'Taste data, product data, and creative performance sit close to decision makers. Netflix can see demand before a traditional studio can schedule a meeting.' },
      { dimension: 'Structural Lock-In', score: 3, explanation: 'Netflix has content obligations and brand commitments, but no parks, cable networks, or legacy retail estate anchoring the model.' },
      { dimension: 'Talent Flow', score: 3, explanation: 'High-talent density remains the operating promise. Creative partner dependence and leadership depth need constant maintenance as the business widens.' },
      { dimension: 'Capital Intensity', score: 4, explanation: 'Content spending is large, but flexible compared with physical networks. Live sports, ads, and games raise the commitment load.' },
      { dimension: 'Knowledge Velocity', score: 3, explanation: 'Viewing behavior becomes merchandising, ad load, language strategy, live programming, and renewal math faster than peers built around old release windows.' },
    ],
    pattern: 'The Audience Became The Studio Brief',
    patternDescription: 'Netflix no longer waits for the market to tell it which stories traveled. The product sees demand in language, completion, rewatch, household sharing, pause behavior, ad response, and live-event curiosity. The company can turn audience behavior into programming supply, pricing logic, and ad inventory faster than studios built around seasonal gates.',
    keyNumbers: [
    ...
    quotable: 'Netflix is less a streamer now than a demand refinery. The raw material is attention; the output is pricing, ads, formats, release timing, and creative supply. Studios still argue over greenlights while Netflix keeps moving closer to pre-selling the shape of the next hit from behavior already sitting in the product.',
    sources: [
      { title: 'Netflix Quarterly Earnings', url: 'https://ir.netflix.net/financials/quarterly-earnings/default.aspx' },
      { title: 'Netflix Q1 2026 Shareholder Letter PDF', url: 'https://s22.q4cdn.com/959853165/files/doc_financials/2026/q1/FINAL-Q1-26-Shareholder-Letter.pdf' },
    ],
  },
  ...
  'amazon': {
    ...
    marketCap: '~$2.4T',
    employees: 1576000,
    revenue: '$181.5B Q1 2026',
    founded: 1994,
    dimensions: [
      { dimension: 'Decision Latency', score: 3, explanation: 'Single-threaded ownership, memo culture, and high internal pressure still keep many decisions close to the work.' },
      { dimension: 'Error Correction', score: 4, explanation: 'Amazon corrects quickly in product and retail operations, but AI infrastructure, labor, and public-market exposure now create slower consequence loops.' },
      { dimension: 'Knowledge Location', score: 3, explanation: 'AWS, ads, stores, logistics, devices, and marketplace all generate operating signal. Amazon remains unusually good at turning internal tools into external businesses.' },
      { dimension: 'Structural Lock-In', score: 4, explanation: 'Fulfillment centers, cloud regions, satellites, delivery routes, and AI compute are powerful assets with growing fixed-commitment weight.' },
      { dimension: 'Talent Flow', score: 5, explanation: 'High bar hiring remains real, but layoffs, RTO tension, warehouse churn, and AI talent competition are now part of the operating load.' },
      { dimension: 'Capital Intensity', score: 7, explanation: 'The company is pouring money into AI infrastructure, AWS capacity, logistics, and Project Kuiper. Scale is still an advantage, but capital hunger is rising.' },
      { dimension: 'Knowledge Velocity', score: 3, explanation: 'Amazon can push learning from AWS, ads, logistics, shopping, and devices across the company faster than most firms of its size.' },
    ],
    pattern: 'The Empire Trains Its Own Nervous System',
    patternDescription: 'Amazon is using AI to make a giant company feel smaller at the decision edge. AWS sells the compute, retail supplies the demand data, ads monetize intent, logistics provides the physical map, and Rufus turns shopping behavior into conversation. The concern is capital pressure: the same AI buildout helping Amazon move faster also forces it to carry more fixed commitment.',
    keyNumbers: [
      'Q1 2026 net sales: $181.5B, up 17%',
      'Q1 2026 operating income: $23.9B',
      'AWS Q1 2026 sales: $37.6B, up 28%',
      'International Q1 2026 sales: $39.8B, up 19%',
      'Amazon database GPI: 3.95, Transitioning',
      'Capital Intensity score: 7',
    ],
    enablers: [
      'AWS funds and sells the AI infrastructure layer',
      'Retail demand data feeds shopping AI',
      'Advertising turns intent into margin',
      'Logistics network gives Amazon a physical execution map',
      'Memo culture still forces decision clarity',
    ],
    friction: [
      ...
      'Union and labor pressure',
    ],
    quotable: 'Amazon is turning AI into internal plumbing before the market finishes calling it a product category. The move is to make every shelf, route, cloud workload, ad slot, and support path train the next decision. The risk is a company built to absorb experiments now carrying infrastructure bills too large to hide inside the old flywheel.',
    sources: [
      { title: 'Amazon Q1 2026 Results', url: 'https://ir.aboutamazon.com/news-release/news-release-details/2026/Amazon-com-Announces-First-Quarter-Results/default.aspx' },
      { title: 'Amazon Investor Relations Overview', url: 'https://ir.aboutamazon.com/overview/default.aspx' },
    ],
  },
  ...
  'ups': {
    ...
    marketCap: '~$84B',
    employees: 460000,
    revenue: '$21.2B Q1 2026',
    founded: 1907,
    dimensions: [
      { dimension: 'Decision Latency', score: 6, explanation: 'UPS is moving faster than the old committee-heavy version, but network decisions still pass through labor, facilities, service commitments, and customer concentration risk.' },
      { dimension: 'Error Correction', score: 6, explanation: 'The Amazon pullback is a real correction. The lag is visible in layoffs, facility actions, and transformation charges after years of volume dependence.' },
      { dimension: 'Knowledge Location', score: 5, explanation: 'Route, customer, package, and facility knowledge sits deep in the operating network. Automation helps, but a large share of judgment still lives in local execution.' },
      { dimension: 'Structural Lock-In', score: 7, explanation: 'Hubs, aircraft, vehicles, union agreements, customer contracts, and automation investments make every pivot heavy.' },
      { dimension: 'Talent Flow', score: 7, explanation: 'Workforce reductions, union structure, and long-tenured operating knowledge create a difficult talent equation: fewer people, less slack, higher need for judgment.' },
      { dimension: 'Capital Intensity', score: 8, explanation: 'The delivery network needs aircraft, trucks, sort centers, automation, fuel, and labor capacity before volume arrives.' },
      { dimension: 'Knowledge Velocity', score: 5, explanation: 'UPS has strong operating systems, but network learning travels through physical constraints. A route insight still has to survive facility reality.' },
    ],
    pattern: 'The Network Is Learning To Refuse Bad Volume',
    patternDescription: 'UPS is moving from volume worship toward volume quality. The Amazon reduction is more than a customer mix decision. It is a test of whether a century-old logistics network can say no to packages which keep assets busy but weaken margin, service focus, and strategic control. The hard part is cultural: a network built for density has to learn selectivity.',
    keyNumbers: [
    ...
    quotable: 'UPS is learning the hardest lesson in logistics: density can become a drug. The next winner in parcel delivery will treat every package as a claim on network time, driver energy, sort capacity, and service reputation. Bad volume fills trucks while hollowing out the business.',
    sources: [
      { title: 'UPS Investor Relations', url: 'https://investors.ups.com/' },
      { title: 'UPS Q1 2026 Earnings PDF', url: 'https://investors.ups.com/_assets/_75989b74b4825c0f1929fbf230dda8aa/ups/news/2026-04-28_UPS_Releases_1Q_2026_2158.pdf' },
    ],
  },
  ...
  'stripe': {
    ...
    state: 'Field',
    dimensions: [
      { dimension: 'Decision Latency', score: 3, explanation: 'Stripe shipped 288 products at Sessions 2026 and moved across Google, OpenAI, Microsoft, Meta, stablecoins, wallets, and usage billing in the same arc. Field-state speed still shows up at $159B scale.' },
      { dimension: 'Error Correction', score: 3, explanation: 'Token theft became a real AI-economy problem, reportedly one in six new signups. Stripe did the useful thing: named the ugly signal publicly, then pushed fraud, metering, and agent-payment tooling into the product surface.' },
      { dimension: 'Knowledge Location', score: 3, explanation: 'Stripe learns from the edge. API traffic, 5M+ businesses, developer docs, Sessions, platform partners, and AI customers all feed the same product system. The company sees billing pain before it becomes a board-slide problem for everyone else.' },
      { dimension: 'Structural Lock-In', score: 5, explanation: 'The more Stripe becomes the meter for AI usage, stablecoins, wallets, and machine payments, the more regulators and large platforms will treat it as public financial plumbing. The FTC debanking warning is the early sign.' },
      { dimension: 'Talent Flow', score: 3, explanation: 'The $159B tender offer gives liquidity without forcing an IPO rhythm. Stripe needs talent to keep moving across payments, AI billing, fraud, stablecoins, and protocols at once.' },
      { dimension: 'Capital Intensity', score: 3, explanation: 'Stripe still avoids factories and stores, but the capital load is shifting into trust infrastructure: Bridge, Privy, Metronome, agent wallets, fraud systems, regulatory work, and partner protocols.' },
      { dimension: 'Knowledge Velocity', score: 2, explanation: 'Stripe caught the AI billing problem early: model costs, token abuse, usage-based revenue, and machine payments are turning into one system. Revenue Suite, Metronome, Radar, Link, Bridge, and Agentic Commerce now belong in the same read.' }
    ],
    pattern: 'The Invoice After The Demo',
    patternDescription: 'The Stripe story starts after the impressive AI demo, when finance has to explain the invoice. Usage spikes, token thieves, model pass-through costs, agent permissions, refunds, taxes, receipts, and stablecoin settlement all land in the same operating mess. Stripe is moving into the mess before it hardens into every company’s back-office headache. The old Stripe helped software accept money. The sharper Stripe helps AI companies turn machine activity into something a customer can understand, trust, dispute, pay for, and renew.',
    keyNumbers: [
      '$159B valuation in February 2026 tender offer, up from $91.5B one year earlier',
      '$1.9T total volume generated by businesses on Stripe in 2025, up 34% from 2024',
      'Equivalent to roughly 1.6% of global GDP moving through Stripe-connected businesses',
      'More than 5M businesses powered directly or through platforms',
      '90% of the Dow Jones Industrial Average and 80% of the Nasdaq 100 powered by Stripe',
      'Revenue suite on track for a $1B annual run rate, up from about $500M in early 2025',
      'Stablecoin payment volume doubled to around $400B in 2025, with Bridge volume more than quadrupling',
      'Sessions 2026 included 288 launches across agents, stablecoins, billing, fraud, and global commerce',
      'Token theft reportedly accounts for 1 in 6 new customer signups, turning AI fraud into a payments-infrastructure problem',
      '57% of new businesses joining Stripe in 2025 were outside the US'
    ],
    enablers: [
    ...
    quotable: 'The agent economy will bottleneck at permission, not intelligence. Stripe is positioning to become the CFO layer for non-human labor: who gets a wallet, who can spend margin, who can trigger a refund, who gets shut off mid-task. Any company building AI without this layer is training unpaid interns with a company card.',
  },
  ...
  'spotify': {
    ...
    marketCap: '~$90B',
    employees: 7691,
    revenue: '€4.5B Q1 2026 revenue',
    founded: 2006,
    dimensions: [
      { dimension: 'Decision Latency', score: 3.5, explanation: 'Spotify moved from podcast cleanup to AI playlists, personal podcasts, audiobooks, video, and licensed remix tools without waiting for a new company identity. Co-CEOs formalize a decision model already running under Ek.' },
      { dimension: 'Error Correction', score: 4, explanation: 'The 2023 layoff overshot the work, then margins improved. Spotify is correcting from volume-at-any-cost into a tighter operating model, but creator trust and AI labeling still create slow public loops.' },
      { dimension: 'Knowledge Location', score: 3, explanation: 'Spotify sits close to the listener moment. Search, skips, saves, playlists, podcasts, audiobooks, prompts, and commute habits create a taste ledger labels and creators can see only in fragments.' },
      { dimension: 'Structural Lock-In', score: 6, explanation: 'The catalog still belongs to rights holders. Universal, Sony, Warner, publishers, artists, podcast partners, and audiobook economics keep Spotify from owning the raw material even when it owns the listener habit.' },
      { dimension: 'Talent Flow', score: 3.7, explanation: 'Remote work, veteran co-CEOs, and product depth keep talent mobile. The risk is cultural whiplash: a music company, ad platform, AI lab, podcast network, and audiobook store now sit inside the same operating system.' },
      { dimension: 'Capital Intensity', score: 5.5, explanation: 'Spotify avoids factories, but royalties, cloud delivery, creator payouts, video, audiobooks, AI tooling, and global licensing function like invisible capital commitments.' },
      { dimension: 'Knowledge Velocity', score: 4, explanation: 'Spotify learns fast from behavior, then runs into rights contracts, creator politics, and platform expectations. The signal moves faster than permission.' },
    ],
    pattern: 'The Shelf Starts Making Inventory',
    patternDescription: 'Spotify spent two decades proving it could organize other people’s audio better than anyone else. The new move is different. Prompted playlists, personal podcasts, AI DJ, audiobook expansion, video podcasts, and licensed AI covers all point to the same operating shift: Spotify wants to turn listener intent into fresh supply inside the app. The old company matched people to songs. The next company may match a moment to whatever audio format can hold it. Music remains the foundation, but taste becomes the production input. Rights holders still own the catalog, so Spotify has to negotiate with the suppliers it is learning to partially replace. This is why the UMG remix deal matters more than a normal licensing announcement. It turns the catalog from finished goods into sanctioned raw material.',
    keyNumbers: [
      '761M monthly active users in Q1 2026, up 12% year over year',
      '293M Premium subscribers in Q1 2026, up 9% year over year',
      '€4.5B Q1 2026 revenue, up 14% year over year on a constant-currency basis',
      '33.0% gross margin in Q1 2026, up about 140 basis points year over year',
      '€715M Q1 2026 operating income',
      'More than $11B paid to the music industry in 2025, with nearly $70B paid all time',
      'Audiobook listening hours up 60% year over year as of May 2026',
      'UMG agreement enables paid AI covers and remixes for participating artists and songwriters',
      'Daniel Ek moved to Executive Chairman in January 2026; Gustav Söderström and Alex Norström became co-CEOs',
      'GPI database score: 4.17, Transitioning, Improving'
    ],
    enablers: [
    ...
    quotable: 'The dangerous move is the shelf learning to make inventory. Spotify used to rent songs from labels and sell access. Now it can take a listener prompt, a taste profile, and a licensed catalog, then make a new thing inside its own checkout. Artists are fighting over stream pennies while the platform moves toward charging for derivatives of the catalog itself.',
    sources: [
      { title: 'Spotify Q1 2026 Earnings', url: 'https://newsroom.spotify.com/2026-04-28/spotify-q1-2026-earnings/' },
      { title: 'Spotify Investor Day 2026 Recap', url: 'https://newsroom.spotify.com/2026-05-21/investor-day-recap/' },
      { title: 'Spotify and Universal Music Group AI Licensing Agreement', url: 'https://newsroom.spotify.com/2026-05-21/universal-music-group-spotify-licensing-agreements-fan-made-covers-remixes/' },
      { title: 'Spotify 2025 Music Industry Payouts', url: 'https://newsroom.spotify.com/2026-01-28/2025-music-industry-payouts-whats-next-for-artists/' },
      { title: 'Spotify Audiobook Updates', url: 'https://newsroom.spotify.com/2026-05-21/investor-day-audiobook-features-updates/' },
      { title: 'Spotify Leadership Evolution', url: 'https://newsroom.spotify.com/2025-09-30/spotify-announcement-daniel-ek-executive-chairman/' },
    ],
  },
  ...
  'anthropic': {
    ...
    state: 'Field',
    ticker: 'Pre-IPO',
    marketCap: '$380B post-money valuation',
    employees: 5000,
    revenue: '$43B ARR per GPI database',
    founded: 2021,
    dimensions: [
      { dimension: 'Decision Latency', score: 2, explanation: 'Anthropic keeps model, product, safety, and enterprise deployment work close together. Claude Code, Claude Enterprise, Cowork, Gov, and partner services move as one operating lane instead of separate product islands.' },
      { dimension: 'Error Correction', score: 3, explanation: 'Anthropic publishes safety research, economic usage studies, cyber-threat mapping, and deployment boundaries while adjusting products around real buyer constraints. The hard loop is public trust when safety posture meets defense demand.' },
      { dimension: 'Knowledge Location', score: 2, explanation: 'Claude usage gives Anthropic a live map of where high-value work is moving: code, finance, legal, support, cybersecurity, scientific work, and internal enterprise knowledge. The company sees workflow migration before most vendors see budget.' },
      { dimension: 'Structural Lock-In', score: 4, explanation: 'Enterprise governance gives Anthropic stickiness, but cloud, compute, government access, and model-risk rules can harden quickly. The company still has more strategic slack than rivals buried under deeper infrastructure commitments.' },
      { dimension: 'Talent Flow', score: 2, explanation: 'The founding technical core remains intact, senior operating talent has joined the board, and Claude Code has become a magnet for engineers who want the model inside real work rather than demos.' },
      { dimension: 'Capital Intensity', score: 7, explanation: '$50B in U.S. AI infrastructure with Fluidstack plus frontier training costs make Anthropic a software company with power-plant physics sitting underneath it.' },
      { dimension: 'Knowledge Velocity', score: 2, explanation: 'Claude Code revenue, enterprise rollouts, internal Economic Index data, and customer deployment examples create fast feedback from live work back into product design.' },
    ],
    pattern: 'Permission Is The Product',
    patternDescription: 'Anthropic is becoming the company enterprises call when frontier AI needs to touch work with consequences. The sharper move sits around the model: identity, audit, data retention, procurement, safety boundaries, government access, regulated deployment, and a partner layer trained to install Claude inside the workflow. Claude Code proved the wedge. Developers brought the model close to production work, then the enterprise buyer needed governance around it. Claude Enterprise, Cowork, Gov, and the services track widen the same path. Anthropic is monetizing the distance between a powerful model and a model a serious organization is allowed to use. The pressure is compute. Each permission win pulls more work into Claude, and more work turns the company into an infrastructure buyer at national scale.',
    keyNumbers: [
      'GPI database score: 3.0, Field, Improving',
      '$380B post-money valuation after $30B Series G funding',
      '$43B ARR in the GPI database, with 9x year-over-year growth noted in May 2026',
      'Claude Code run-rate revenue above $2.5B and more than doubled since the start of 2026',
      'More than 500 customers above $1M in annualized spend; eight of the Fortune 10 use Claude',
      '$50B U.S. AI infrastructure plan with Fluidstack in Texas and New York',
      'Approximately 800 permanent jobs and 2,400 construction jobs tied to the infrastructure buildout',
      'Smartsheet engineers using Claude Code ship 3x more code and merge 31% more pull requests than peers',
      'Within 2.5 weeks of Smartsheet company-wide launch, 49% of employees were actively using Claude Enterprise',
      'Claude Gov models are deployed for classified U.S. national security environments',
    ],
    enablers: [
      'Claude Code gives Anthropic a direct path into production engineering work',
      'Claude Enterprise packages identity, retention, audit, and access control around frontier capability',
      'Claude Gov opens a specialized lane for classified national-security use',
      'Economic Index data lets Anthropic see how work habits evolve as users gain tenure',
      'Partner services turn trust and deployment knowledge into a distribution channel',
      'Large enterprise customers expand from one use case into workforce-wide deployments',
      'Founding technical continuity keeps safety, research, and product judgment close',
    ],
    friction: [
      'Compute demand can turn every enterprise win into a bigger infrastructure obligation',
      'Safety credibility can collide with defense, intelligence, and national-security demand',
      'Customers may love Claude Code while finance pushes token limits and ROI reviews',
      'Government access creates reputational heat from both sides of the safety debate',
      'Enterprise governance slows the sale even when users already want the product',
      'OpenAI, Google, Microsoft, AWS, and Meta can bundle models into platforms buyers already pay for',
    ],
    quotable: 'Anthropic is building the permission layer for frontier AI. The model gets attention, but the money sits in deciding which machine can touch code, records, customers, classified work, and regulated judgment. If Claude becomes the approved worker inside serious systems, Anthropic owns the gate before it owns the task.',
    sources: [
      { title: 'Anthropic Series G Funding', url: 'https://www.anthropic.com/news/anthropic-raises-30-billion-series-g-funding-380-billion-post-money-valuation' },
      { title: 'Anthropic $50B Infrastructure Investment', url: 'https://www.anthropic.com/news/anthropic-invests-50-billion-in-american-ai-infrastructure' },
      { title: 'Claude Enterprise', url: 'https://www.anthropic.com/product/enterprise' },
      { title: 'Claude Gov Models', url: 'https://www.anthropic.com/news/claude-gov-models-for-u-s-national-security-customers' },
      { title: 'Anthropic Economic Index March 2026', url: 'https://www.anthropic.com/research/economic-index-march-2026-report' },
      { title: 'Department of War Update', url: 'https://www.anthropic.com/news/where-stand-department-war' },
    ],
  },
  ...
  'canva': {
    ...
    state: 'Transitioning',
    ticker: 'Private',
    marketCap: '~$42B private valuation',
    employees: 5300,
    revenue: '$4B ARR reported for 2025',
    founded: 2012,
    dimensions: [
      { dimension: 'Decision Latency', score: 3, explanation: 'Founder control, product-led habits, and private status still keep big calls close to the work.' },
      { dimension: 'Error Correction', score: 4, explanation: 'Canva adjusts product fast, but pricing trust, layoffs, and enterprise governance create slower repair loops.' },
      { dimension: 'Knowledge Location', score: 3, explanation: 'Usage signal sits inside the editor, templates, teams, brand kits, AI prompts, and enterprise admin layer.' },
      { dimension: 'Structural Lock-In', score: 3, explanation: 'The asset-light SaaS base lets Canva widen from design into work without factories, stores, or legacy hardware.' },
      { dimension: 'Talent Flow', score: 4, explanation: 'Growth still attracts builders, but IPO prep, AI role shifts, and retention pressure raise the people tax.' },
      { dimension: 'Capital Intensity', score: 2, explanation: 'Canva scales through software, data, templates, AI, and distribution. The balance sheet carries far less weight than industrial peers.' },
      { dimension: 'Knowledge Velocity', score: 3, explanation: 'The product sees what teams create, revise, brand, share, and reuse. Learning travels quickly when the work surface owns the draft.' }
    ],
    pattern: 'The Draft Became The Workflow',
    patternDescription: 'Canva won by making design feel safe for people who were never going to become designers. The next move is bigger: turn every first draft into a governed work asset. A social post, sales deck, HR flyer, product one-pager, data chart, video, and internal campaign can now begin in the same surface, carry brand rules, pull AI help, and stay visible to the organization. Adobe owns professional depth. Canva is trying to own the moment work first becomes visible.',
    keyNumbers: [
    ...
    quotable: 'Canva is chasing the first messy version of work. Whoever owns the draft owns the handoff, the brand rules, the approval trail, the AI assist, and the next campaign. The quiet threat to Adobe is amateur creation turning into enterprise memory before a professional tool enters the workflow.',
    sources: [
      { title: 'Canva AI 2.0', url: 'https://www.canva.com/canva-ai/' },
      { title: 'Canva Enterprise Momentum', url: 'https://www.canva.com/newsroom/news/one-year-canva-enterprise/' },
      { title: 'Canva CNBC Disruptor 50 2025', url: 'https://www.canva.com/newsroom/news/cnbc-disruptor-50-2025/' },
      { title: 'TechCrunch Canva ARR Report', url: 'https://techcrunch.com/2026/02/18/canva-gets-to-4b-in-revenue-as-llm-referral-traffic-rises/' },
    ],
  },
