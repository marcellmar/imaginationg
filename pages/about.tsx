...
const AboutPage = () => {
  return (
    <>
      <Head>
        <title>About IG | We Collide. We Leave.</title>
        <meta name="description" content="We don't consult. We don't coach. We don't facilitate. We collide." />
      ...
      <div className="min-h-screen bg-black text-white font-sans">
        ...
        <header className="pt-32 pb-16 px-6 text-center">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">ABOUT IG</h1>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-0 max-w-5xl mx-auto">
              ...
              <div className="border border-zinc-800 p-8">
                <h2 className="text-3xl font-bold mb-6">WHAT WE ARE</h2>
              ...
              {/* What We're Not */}
              <div className="border border-zinc-800 p-8">
                <h2 className="text-3xl font-bold mb-6">WHAT WE'RE NOT</h2>
                <div className="space-y-4 text-lg">
              ...
              <div className="border border-zinc-800 p-8 md:col-span-2">
                <h2 className="text-3xl font-bold mb-6">OUR CODE</h2>
