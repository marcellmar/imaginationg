      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <section className="pt-24 pb-16 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-4 mb-6">
              <span className="text-xs font-mono text-red-600 bg-red-600/10 px-3 py-1">LIVE ANALYSIS</span>
              <span className="text-xs text-zinc-500">Feb 26, 2026</span>
              <span className="text-xs text-zinc-600">•</span>
              <span className="text-xs text-zinc-500">GPI · ACQUISITIONS · METABOLIC COMPATIBILITY</span>
            </div>
            ...
            <p className="text-xl text-zinc-400 max-w-2xl mb-4">
            ...
            <div className="mt-16 max-w-2xl">
              <div className="text-xs font-mono text-zinc-600 mb-4">THE GPI GAP</div>
              <div className="bg-zinc-950 border border-zinc-800 p-8">
                <svg viewBox="0 0 400 160" className="w-full">
                  ...
                  {/* Scale labels */}
                  <text x="40" y="95" fill="#52525b" fontSize="8" fontFamily="monospace">1</text>
                  <text x="196" y="95" fill="#52525b" fontSize="8" fontFamily="monospace">5</text>
                  <text x="352" y="95" fill="#52525b" fontSize="8" fontFamily="monospace">10</text>
                  ...
                  <text x="175" y="150" textAnchor="middle" fill="#71717a" fontSize="8" fontFamily="monospace">PORTFOLIO ZONE — NEVER INTEGRATE</text>
                </svg>
              </div>
            </div>
          </div>
        ...
        <section className="py-8 px-6">
          <div className="max-w-3xl mx-auto space-y-16">
            ...
            <div className="space-y-4 text-zinc-300">
              ...
              <p className="text-white text-xl font-bold pt-4">The market wasn't consoling Netflix. It was relieved.</p>
            </div>

            {/* Quote */}
            <div className="bg-zinc-950 border border-zinc-800 p-8">
              <p className="text-2xl text-white italic">"At the price required to match Paramount's offer, the deal is no longer financially attractive."</p>
              <p className="text-zinc-500 text-sm mt-3">Netflix, February 26, 2026</p>
            </div>

            {/* The bid made sense section */}
            <div>
              <div className="text-xs font-mono text-zinc-500 mb-6">THE $82.7B THESIS</div>
              <div className="space-y-4 text-zinc-300">
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div className="bg-zinc-950 border border-zinc-800 p-5">
                ...
                <p className="text-zinc-500 text-xs mt-2">GPI point gap</p>
                <p className="text-zinc-600 text-xs mt-1">Portfolio zone. Never integrate.</p>
              </div>
              <div className="bg-zinc-950 border border-zinc-800 p-5">
                <p className="text-3xl font-black text-white">$2.8B</p>
                <p className="text-zinc-500 text-xs mt-2">Netflix termination fee</p>
                <p className="text-zinc-600 text-xs mt-1">Paid by Paramount to Netflix</p>
              </div>
              <div className="bg-zinc-950 border border-zinc-800 p-5">
                <p className="text-3xl font-black text-green-500">+13%</p>
                <p className="text-zinc-500 text-xs mt-2">Netflix stock on exit</p>
                <p className="text-zinc-600 text-xs mt-1">Market's verdict</p>
              </div>
            </div>

            {/* The metabolic incompatibility */}
            <div>
              <div className="text-xs font-mono text-zinc-500 mb-6">THE PRICE WHERE PHYSICS BREAKS</div>
              <div className="space-y-4 text-zinc-300">
            ...
            {/* Dimension breakdown */}
            <div className="bg-zinc-950 border border-zinc-800 p-8">
              <div className="text-xs font-mono text-zinc-500 mb-6">DIMENSION MISMATCH</div>
                ...
                {[
                  ...
                  <div key={i} className="border-b border-zinc-800 pb-4 last:border-0 last:pb-0">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm font-bold text-white">{row.dim}</span>
            ...
            <div>
              <div className="text-xs font-mono text-zinc-500 mb-6">+13% IS THE WHOLE ANALYSIS</div>
              <div className="space-y-4 text-zinc-300">
            ...
            <div className="border-l-2 border-red-600 pl-6 space-y-4">
              ...
              <p className="text-zinc-300">Netflix is a K-strategist in a digital winner-take-most biome: efficient, margin-driven, optimized for subscriber retention and content ROI. Every decision runs through a data loop. It's built for a world where speed of learning compounds.</p>
              <p className="text-zinc-300">WBD is an r-strategist from a linear TV biome that's shrinking. It produces a lot, bets broadly, and relies on theatrical releases and cable bundles that are declining as a category. The org evolved for abundance in a world moving toward scarcity.</p>
              <p className="text-zinc-300">Merging them doesn't accelerate WBD into Netflix's biome. It drags Netflix back toward WBD's. The slower metabolism wins by default because the heavier infrastructure dominates the operating decisions.</p>
            </div>

            {/* Closing */}
            <div className="bg-red-600/10 border border-red-600/30 p-8 space-y-4">
              <p className="text-white font-bold text-2xl">The $2.8B termination fee is the cheapest outcome Netflix could have gotten from this deal.</p>
              <p className="text-zinc-300">At $82.7B the content thesis was real. At $110.9B Netflix was being asked to buy the infrastructure, the org chart, the approval chains, and two competing cultures that haven't resolved since 2022. They measured the gap. They said no.</p>
        ...
        <section className="py-16 px-6 border-t border-zinc-900">
          <div className="max-w-3xl mx-auto">
            <p className="text-zinc-400 mb-2 text-sm font-mono">THE ACQUISITION MATH WORKS FOR ANY DEAL</p>
