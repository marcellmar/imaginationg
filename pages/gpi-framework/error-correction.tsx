        ...
        <section className="py-16 px-6 border-t border-stone-200">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between gap-6">
              <Link href="/gpi-framework/decision-latency" className="border border-stone-300 px-8 py-4 text-lg font-black hover:border-red-400 transition-colors text-center">
                ← DECISION LATENCY
              </Link>
              <Link href="/gpi-framework/knowledge-location" className="bg-red-600 text-white px-8 py-4 text-lg font-black hover:bg-red-700 transition-colors text-center">
