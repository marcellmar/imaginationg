    ...
    <>
      ...
      <div className="min-h-screen bg-stone-50 text-stone-900">
        ...
        <section className="py-16 px-6 border-t border-stone-200 bg-white">
          <div className="max-w-4xl mx-auto">
            <div className="text-xs font-mono text-stone-400 mb-2">THE GPI SCALE</div>
            ...
            <div className="mb-12">
              ...
              <div className="flex justify-between mt-2 text-xs font-mono text-stone-400">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="border border-stone-200 p-6">
                ...
                <div className="text-xl font-black text-stone-900 mb-3">FIELD STATE</div>
                <p className="text-stone-500 text-sm mb-4">Energy flows freely. Decisions happen at the edge. The org learns faster than it plans. Built for Grasslands and fast-moving Rivers.</p>
                <Link href="/gpi-framework/field-state" className="text-xs font-mono text-green-500 hover:text-green-600">
                  FIELD STATE →
                </Link>
              </div>
              ...
              <div className="border border-stone-200 p-6">
                ...
                <div className="text-xl font-black text-stone-900 mb-3">TRANSITIONING</div>
                <p className="text-stone-500 text-sm mb-4">Mixed metabolism. Some energy flows, some gets trapped. Can go either direction. The window where intervention actually changes things.</p>
                <Link href="/gpi-framework/transition-state" className="text-xs font-mono text-yellow-500 hover:text-yellow-600">
                  TRANSITION STATE →
                </Link>
              </div>
              ...
              <div className="border border-stone-200 p-6">
                ...
                <div className="text-xl font-black text-stone-900 mb-3">PARTICLE STATE</div>
                <p className="text-stone-500 text-sm mb-4">Hierarchy routes everything. Energy gets trapped at approval layers. Can be optimal in Swamps. Lethal in Grasslands.</p>
                <Link href="/gpi-framework/particle-state" className="text-xs font-mono text-red-500 hover:text-red-600">
                  PARTICLE STATE →
                </Link>
              </div>
            </div>
        ...
        <section className="py-16 px-6 border-t border-stone-200">
          <div className="max-w-4xl mx-auto">
            <div className="text-xs font-mono text-stone-400 mb-2">HOW THE SCORE IS BUILT</div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {[
                ...
                <Link key={dim.name} href={`/gpi-framework/${dim.slug}`} className="group">
                  <div className="border border-stone-200 p-6 hover:border-red-400 transition-colors h-full">
                    <div className="flex items-start gap-3 mb-3">
                      <dim.icon size={16} className="text-red-600 mt-0.5 flex-shrink-0" />
                      <h3 className="font-black text-stone-900 group-hover:text-red-600 transition-colors text-sm">{dim.name}</h3>
                    </div>
                    <p className="text-stone-500 text-sm">{dim.desc}</p>
                  </div>
                </Link>
              ))}
            </div>
        ...
        <section className="py-16 px-6 border-t border-stone-200 bg-white">
          <div className="max-w-4xl mx-auto">
            <div className="text-xs font-mono text-stone-400 mb-2">CONTEXT CHANGES EVERYTHING</div>
            ...
            <div className="space-y-0">
              {[
                ...
                { name: 'DESERTS', desc: 'Resources extracted faster than regeneration.', examples: 'Print media, coal, late retail', tolerance: 'Autopsy', color: 'text-stone-500' },
              ].map((biome, i) => (
                <div key={i} className="flex items-center gap-6 py-4 border-b border-stone-200 last:border-0">
        ...
        <section className="py-16 px-6 border-t border-stone-200">
          <div className="max-w-4xl mx-auto">
            <div className="text-xs font-mono text-stone-400 mb-2">SPECIES TYPE</div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="border border-stone-200 p-6">
                ...
                <p className="text-stone-600 text-sm mb-3">Volume over quality. Thin margins, massive scale, rapid replacement. Dandelions. Bacteria. Walmart.</p>
              ...
              <div className="border border-stone-200 p-6">
                ...
                <p className="text-stone-600 text-sm mb-3">Quality over volume. Fat margins, deliberate scarcity, generational durability. Redwood trees. Whales. Hermès.</p>
            ...
            <div className="border-l-2 border-red-600 pl-6">
              ...
              <p className="text-stone-500 text-xs mt-3">Wrong species for the terrain. GPI doesn't save you from that.</p>
            </div>
          </div>
        </section>
